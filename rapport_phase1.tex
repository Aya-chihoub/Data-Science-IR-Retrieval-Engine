...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/categories.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Images/visualisation_tsne.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Images/visualisation_umap.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/mdoel_compar.png}
...
For the 141 test queries, we generated embeddings using the same model and retrieved the top-10 most similar documents. Since category classification is not part of Phase~1, we left the category field as ``?'' in the submission file. Category prediction will be addressed in Phase~2.
